...
export default defineConfig({
  ...
  webServer: [
    {
      command:
        "CLIENT_ID=demo FRONTEND_ORIGIN=http://127.0.0.1:3000 ORDER_DB_PATH=/tmp/store-platform-e2e.sqlite3 .venv/bin/uvicorn apps.api.main:app --host 127.0.0.1 --port 8000",
      url: `${API_URL}/health`,
