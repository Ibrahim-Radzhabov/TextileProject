...
export const ProductCard: React.FC<ProductCardProps> = ({
  ...
  const handleImgError = React.useCallback(
    (e: React.SyntheticEvent<HTMLImageElement>) => {
      ...
      // Show gradient placeholder on the aspect-ratio container
      const container = img.closest("[data-img-container]") as HTMLElement | null;
      if (container) {
        container.style.background =
          "linear-gradient(135deg, #E8E2DA 0%, #D4CBC0 100%)";
      }
    },
    []
  );
  ...
  return (
    ...
    >
      ...
      >
        <div className={["relative overflow-hidden img-hover-zoom", isEditorial ? "" : ""].join(" ")}>
          <a
            href={productHref}
        ...
        <div
          className={[
            ...
            isEditorial ? "gap-1.5 px-0 pb-1 pt-3" : "gap-2.5 p-3.5 sm:p-3.5"
          ].join(" ")}
        >
          <div
            className={
          ...
          <div
            className={[
              ...
              isEditorial ? "pt-0" : isNamePrice ? "border-t border-border pt-2.5" : "pt-1.5"
            ].join(" ")}
          >
