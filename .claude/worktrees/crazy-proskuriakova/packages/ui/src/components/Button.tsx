...
const baseClasses =
  "ui-button relative isolate inline-flex items-center justify-center overflow-hidden border transition-all duration-200 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-foreground focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:cursor-not-allowed disabled:opacity-40";
...
const variantClasses: Record<ButtonVariant, string> = {
  primary:
    "border-foreground bg-foreground text-background hover:opacity-80 active:translate-y-px",
  secondary:
    "border-foreground/20 bg-transparent text-foreground hover:border-foreground/40",
  ghost:
    "border-transparent bg-transparent text-foreground hover:border-foreground/20"
};
