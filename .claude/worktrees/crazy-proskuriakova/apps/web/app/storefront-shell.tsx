            ...
            rightSlot={
              <>
                <button
                  ...
                  className="inline-flex items-center gap-1.5 text-[11px] font-medium uppercase tracking-[0.1em] text-foreground/50 transition-colors hover:text-foreground"
                  aria-label="Поиск"
                >
                  Поиск
                </button>
                <a
                  href="/favorites"
                  className="hidden sm:inline-flex items-center gap-1.5 text-[11px] font-medium uppercase tracking-[0.1em] text-foreground/50 transition-colors hover:text-foreground"
                >
