...
export function ProductPageClient({
  ...
  return (
    <div className="space-y-8 pb-[calc(10.75rem+env(safe-area-inset-bottom))] md:space-y-10 md:pb-10">
      <div className="grid gap-10 sm:gap-12 md:grid-cols-[minmax(0,1fr)_22rem] lg:gap-16 lg:grid-cols-[minmax(0,1fr)_26rem] xl:grid-cols-[minmax(0,1fr)_28rem]">
        <motion.div
        ...
        <motion.div
          ...
          className="space-y-5 md:space-y-6 md:sticky md:top-24 md:w-full md:self-start"
        >
