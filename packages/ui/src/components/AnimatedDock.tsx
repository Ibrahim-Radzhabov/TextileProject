  ...
  return (
    ...
    >
      {items.map((item, index) => {
        ...
        const scale = prefersReducedMotion ? 1 : isHovered ? (isCapsule ? 1.06 : isMinimal ? 1.018 : 1.14) : 1;
          ...
          <>
            <span
              className={[
                ...
                isMinimal
                  ? "h-[2.625rem] w-[2.625rem] border border-[rgba(104,86,69,0.12)] bg-[linear-gradient(180deg,rgba(255,255,255,0.78),rgba(246,240,232,0.68))] text-foreground/78 shadow-[0_12px_24px_-20px_rgba(74,58,44,0.38),inset_0_1px_0_rgba(255,255,255,0.9)] backdrop-blur-[10px] hover:border-[rgba(104,86,69,0.2)] hover:bg-[linear-gradient(180deg,rgba(255,255,255,0.9),rgba(248,242,235,0.82))] hover:text-foreground/92 [&>svg]:h-[17px] [&>svg]:w-[17px] sm:h-[2.875rem] sm:w-[2.875rem] sm:[&>svg]:h-[18px] sm:[&>svg]:w-[18px]"
                  :
                isCapsule
              ...
              {item.badge != null && item.badge > 0 && (
                <span
                  className={[
                    ...
                    isMinimal
                      ? "h-[17px] min-w-[17px] border border-white/88 bg-[linear-gradient(180deg,#241d18,#3a2b21)] px-1 text-[8px] font-semibold tracking-[0.04em] text-[#f7f0e7] shadow-[0_10px_16px_-14px_rgba(0,0,0,0.6)]"
                      :
                    isCapsule
