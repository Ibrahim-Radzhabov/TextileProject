  ...
  return (
    <div className="page-shell min-h-screen">
      {topNav && (
        <motion.div
          className={[
            "sticky top-0 z-40 border-b border-foreground/[0.06] bg-background/92 transition-colors duration-[var(--motion-normal)]",
            isScrolled ? "bg-background/96" : "bg-background/92"
          ].join(" ")}
